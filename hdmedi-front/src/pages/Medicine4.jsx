...
const Information = () => {
  ...
  const dummyData = {
    general: (
      <div className="formatted-text">
        ...
        <p>
          1. 두통, 치통, 발치 후 동통(통증), 인후(목구멍)통, 귀의 통증, 관절통, 신경통, 요통, 근육통, 견통(어깨결림), 타박통, 골절통, 염좌통(삠통증), 월경통(생리통), 외상통의 진통
        </p>
        <p>
  ...
  return (
    ...
    <div className="information-page">
      ...
      {/* 약 이름 & 이미지 삽입 */}
      <h1 className="medication-name">모아펜소프트연질캡슐</h1>
